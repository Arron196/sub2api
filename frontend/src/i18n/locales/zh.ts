export default {
  ...
  admin: {
    ...
    settings: {
      ...
      debugData: {
        title: '系统调试导出',
        description: '下载仅管理员可用的 JSON 排障包，包含更详细的服务器、日志、调度和配置诊断信息。',
        redactionNotice: '导出内容使用固定白名单字段，并经过最终脱敏处理。对外分享前仍请先检查。',
        safeContents: '包含运行时元数据、服务器状态、安全配置标志、运维计数器、日志归因和账号调度诊断。',
        detailLevelLabel: '导出详细程度',
        detailLevelHint: '支持模式会扩大安全日志归因窗口，但仍保留采样上限和超时保护。',
        detailLevels: {
          standard: '标准',
          detailed: '详细',
          support: '支持排障 / 最详细'
        },
        moreSensitiveLabel: '更多敏感数据导出',
        ...
        customLogStartLabel: '开始时间',
        customLogEndLabel: '结束时间',
        customLogRangeHint: '自定义范围最长 7 天，结束时间不能晚于当前时间。',
        customLogRangeInvalid: '请选择有效的日志开始和结束时间。',
        export: '创建调试导出任务',
        exporting: '创建中...',
        exportSuccess: '调试包已下载',
        exportFailed: '创建调试导出任务失败',
        jobCreated: '调试导出任务已创建',
        jobsTitle: '最近的调试导出任务',
        jobsRetainHint: '文件会在 24 小时后过期。',
        refreshJobs: '刷新任务',
        noJobs: '暂无调试导出任务。',
        loadJobsFailed: '加载调试导出任务失败',
        cancelJob: '取消',
        cancelSuccess: '调试导出任务已取消',
        cancelFailed: '取消调试导出任务失败',
        downloadJob: '下载',
        phaseUnknown: '等待中',
        jobBytes: '已写入 {bytes}',
        jobExpires: '{time} 过期',
