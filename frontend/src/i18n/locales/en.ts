export default {
  ...
  admin: {
    ...
    settings: {
      ...
      debugData: {
        title: 'System Debug Export',
        description: 'Download an admin-only JSON support bundle with detailed server, log, scheduling, and configuration diagnostics.',
        redactionNotice: 'The export uses fixed allowlisted fields and a final redaction pass. Review before sharing externally.',
        safeContents: 'Includes runtime metadata, server conditions, safe configuration flags, ops counters, log attribution, and account scheduling diagnostics.',
        detailLevelLabel: 'Export detail',
        detailLevelHint: 'Support mode includes a wider safe log attribution window while keeping hard limits and timeouts.',
        detailLevels: {
          standard: 'Standard',
          detailed: 'Detailed',
          support: 'Support / most detailed'
        },
        moreSensitiveLabel: 'More sensitive data export',
        ...
        customLogStartLabel: 'Start time',
        customLogEndLabel: 'End time',
        customLogRangeHint: 'Custom ranges can be at most 7 days and the end time cannot be in the future.',
        customLogRangeInvalid: 'Select a valid log start and end time.',
        export: 'Create Debug Export Job',
        exporting: 'Creating...',
        exportSuccess: 'Debug bundle downloaded',
        exportFailed: 'Failed to create debug export job',
        jobCreated: 'Debug export job created',
        jobsTitle: 'Recent debug export jobs',
        jobsRetainHint: 'Artifacts expire after 24 hours.',
        refreshJobs: 'Refresh jobs',
        noJobs: 'No debug export jobs yet.',
        loadJobsFailed: 'Failed to load debug export jobs',
        cancelJob: 'Cancel',
        cancelSuccess: 'Debug export job canceled',
        cancelFailed: 'Failed to cancel debug export job',
        downloadJob: 'Download',
        phaseUnknown: 'waiting',
        jobBytes: '{bytes} written',
        jobExpires: 'Expires {time}',
        jobStatuses: {
          pending: 'Pending',
          running: 'Running',
          succeeded: 'Ready',
