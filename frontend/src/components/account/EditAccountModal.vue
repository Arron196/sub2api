...
import type { Account, Proxy, AdminGroup, CheckMixedChannelResponse, OpenAICompactMode, OpenAIAPIKeyUpstreamMode, OpenAIResponsesMode } from '@/types'
...
const syncFormFromAccount = (newAccount: Account | null) => {
  ...
  if (newAccount.platform === 'openai' && (newAccount.type === 'oauth' || newAccount.type === 'apikey')) {
    ...
    if (newAccount.type === 'apikey') {
      ...
      if (isOpenAIAPIKeyUpstreamMode(upstreamMode)) {
