...
vi.mock('@/utils/format', () => ({
  formatDateTime: (value: string | number | null | undefined) => value == null ? '' : String(value),
  formatDateTimeLocalInput: (value: number | null) => value == null ? '' : String(value),
  parseDateTimeLocalInput: (value: string) => value ? Number(value) || null : null
}))
